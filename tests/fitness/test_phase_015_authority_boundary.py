...
def test_phase_015_current_authority_is_discoverable() -> None:
    ...
    assert "015-C        AUTHORIZED / ACTIVE" in authority_text
    assert "015-D..015-J NOT AUTHORIZED" in authority_text


def test_phase_015_index_exposes_015_c_as_active() -> None:
    ...
    assert "015-C" in phase_text and "AUTHORIZED / ACTIVE" in phase_text
...
def test_agent_instructions_preserve_active_015_c_authority_boundary() -> None:
