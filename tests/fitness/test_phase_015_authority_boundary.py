...
def test_phase_015_index_exposes_015_f_as_next_but_not_authorized() -> None:
    ...
    assert "015-F" in phase_text and "NEXT ELIGIBLE / NOT AUTHORIZED" in phase_text
...
def test_agent_instructions_preserve_post_015_e_authority_boundary() -> None:
    ...
    assert "015-F                                 NEXT ELIGIBLE / NOT AUTHORIZED" in agent_text
