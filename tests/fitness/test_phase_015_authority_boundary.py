...
def test_phase_016_hardening_authority_is_current() -> None:
    ...
    assert "016-E       NEXT ELIGIBLE / NOT AUTHORIZED" in authority_text
    ...
    assert "016-E       NEXT ELIGIBLE / NOT AUTHORIZED" in phase_text
...
def test_agent_instructions_preserve_phase_016_scope_boundary() -> None:
    ...
    assert "016-A through 016-D are complete" in agent_text
    assert "016-E is NEXT ELIGIBLE / NOT AUTHORIZED" in agent_text
