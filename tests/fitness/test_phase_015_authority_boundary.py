...
def test_phase_016_hardening_authority_is_current() -> None:
    ...
    assert "016-D       AUTHORIZED / ACTIVE" in authority_text
    ...
    assert "016-D       AUTHORIZED / ACTIVE" in phase_text
...
def test_agent_instructions_preserve_phase_016_scope_boundary() -> None:
    ...
    assert "016-A through 016-C are complete" in agent_text
    assert "016-D is AUTHORIZED / ACTIVE" in agent_text
