...
def test_phase_015_current_authority_is_discoverable() -> None:
    ...
    assert "015-D        NEXT ELIGIBLE / NOT AUTHORIZED" in authority_text
    assert "015-E..015-J NOT AUTHORIZED" in authority_text


def test_phase_015_index_exposes_015_d_as_next_but_not_authorized() -> None:
    ...
    assert "015-D" in phase_text and "NEXT ELIGIBLE / NOT AUTHORIZED" in phase_text
...
def test_agent_instructions_preserve_post_015_c_authority_boundary() -> None:
    ...
    assert "015-D                                 NEXT ELIGIBLE / NOT AUTHORIZED" in agent_text
